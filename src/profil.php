...
echo '<p class="center"><img class="tbp" src="'.user_avatar_url($photo, $prenom).'"/></p>';
if(has_photo_file($photo) && $edit) echo '<p><a href="r_supprime_photo.php">Retirer la photo</a></p>';
if ($edit) {
...
if ($edit) {
	...
	echo '<tr><th><span class="emoji-icon with-gap" aria-hidden="true">🙂</span>Aime</th></tr>';
...
if ($edit) {
	...
	echo '<p><table class="gifts">';
	echo '<tr><th><span class="emoji-icon with-gap" aria-hidden="true">🙃</span>Aime pas</th></tr>';
